...
export const NFT_CONTRACT_ADDRESS =
  "0xc99eCfbeFb7C2ED3a46e3FBe7AC25084b0E480d8";
...
// 체크할 것
// 1. phase 1인지 2인지
// 2. toggle publicM presaleM
// 3. setCurrentPhase
// 4. 컨트랙에 presale block 설정 했는지 public block 설정 했는지
// 5. presale이랑 public sale이랑 헷갈리지 말자
const isTest = false;
export const config = {
  NFT_CONTRACT_ABI,
  ...
  price: 0,
  maxMintSupply: isTest ? 10 : 5000,
  currentPhase: 1,
  isTest: isTest,
  txURL: isTest
    ? "https://baobab.scope.klaytn.com/tx"
    : "https://scope.klaytn.com/tx",
  presaleMintingBlock: 95728266, // 7월 12일 오후 8시
  publicMintingBlock: 95818266, // 7월 13일 오후 9시
};
